#produce circular dendrogram and legends from the tree written in the newick format, FIGURE 2
#input: chr6_newick.txt, here dendrogram for chr 6 written in the newick format where labels are Targets (modifiers)
import random
import re
...
s = open('./data/chr6_newick.txt', 'r').read()
