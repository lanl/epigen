...
def process_subset(subset_df, df_chr6, df38_full):
    ...
    sub_cell   = pd.merge(df38_full, filtered_df, left_on='Accession', right_on=filtered_df.index, how='inner')['Biosample term name'].tolist()
    ...
    labels_cell     = pd.merge(df38_full, filtered_df, left_on='Accession', right_on=filtered_df.index, how='inner')['Biosample term name'].tolist()
