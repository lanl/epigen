...
#Figure 3
chr_id_1 = 6
cor_dist = pd.read_csv("./results38/hg38_chr" + str(chr_id_1) + "_200data" + 'correlation.h5', index_col=0) #pre-computed cor for chr 6 hg38 (look at the script that producing it)
...
colors = ['rgb(0, 0, 128)', 'rgb(128, 128, 128)', 'rgb(0, 0, 0)', 'rgb(230, 25, 75)', 'rgb(60, 180, 75)', 'rgb(255, 225, 25)', 'rgb(0, 130, 200)', 'rgb(245, 130, 48)', 'rgb(145, 30, 180)', 'rgb(70, 240, 240)', 'rgb(240, 50, 230)', 'rgb(210, 245, 60)', 'rgb(250, 190, 212)', 'rgb(0, 128, 128)', 'rgb(220, 190, 255)', 'rgb(170, 110, 40)', 'rgb(255, 250, 200)', 'rgb(128, 0, 0)', 'rgb(170, 255, 195)', 'rgb(128, 128, 0)', 'rgb(255, 215, 180)',  'rgb(255, 255, 255)']
data_graph = []
...
'rgb(0,255,255)', 'rgb(255,0,255)', 'rgb(192,192,192)', 'rgb(128,128,128)', 'rgb(128,0,0)',
'rgb(128,128,0)', 'rgb(0,128,0)', 'rgb(128,0,128)', 'rgb(0,128,128)', 'rgb(0,0,128)', 'rgb(250,128,114)',
'rgb(255,160,122)', 'rgb(255,69,0)', 'rgb(255,140,0)', 'rgb(255,165,0)', 'rgb(255,215,0)', 'rgb(184,134,11)',
'rgb(218,165,32)', 'rgb(238,232,170)', 'rgb(189,183,107)', 'rgb(240,230,140)', 'rgb(128,128,0)', 'rgb(255,255,0)',
'rgb(154,205,50)', 'rgb(85,107,47)', 'rgb(107,142,35)', 'rgb(124,252,0)', 'rgb(34,139,34)', 'rgb(0,100,0)',
'rgb(32,178,170)', 'rgb(47,79,79)', 'rgb(0,128,128)', 'rgb(176,224,230)', 'rgb(95,158,160)', 'rgb(70,130,180)',
'rgb(100,149,237)', 'rgb(0,191,255)', 'rgb(30,144,255)', 'rgb(0,0,139)', 'rgb(0,0,205)', 'rgb(65,105,225)', 'rgb(138,43,226)',
'rgb(75,0,130)', 'rgb(72,61,139)', 'rgb(106,90,205)', 'rgb(123,104,238)', 'rgb(147,112,219)', 'rgb(139,0,139)', 'rgb(148,0,211)',
'rgb(255,0,255)', 'rgb(218,112,214)', 'rgb(199,21,133)', 'rgb(219,112,147)', 'rgb(255,20,147)', 'rgb(255,105,180)', 'rgb(255,192,203)',
'rgb(250,235,215)', 'rgb(245,245,220)', 'rgb(255,228,196)', 'rgb(160,82,45)', 'rgb(210,105,30)', 'rgb(205,133,63)', 'rgb(244,164,96)',
'rgb(222,184,135)', 'rgb(210,180,140)', 'rgb(188,143,143)', 'rgb(245,255,250)', 'rgb(112,128,144)', 'rgb(176,196,222)', 'rgb(230,230,250)']
...
for type_value in dfu.index.unique():
    ...
    graph = go.Scatter3d(
        ...
        marker = dict(
            size = 8,
            color = dfu[mask]['color'],
            symbol = dfu[mask]['marker_shape'],
            line = dict(
                color = dfu[mask]['color'],
                width = 0.5
            ),
...
import pandas as pd
import plotly.graph_objs as go
df38['factor_class'] = df38['factor_class'].replace('Non-Histone: post-transcriptional regulator', 
                                                    'Non-Histone: Post-transcriptional regulator')
